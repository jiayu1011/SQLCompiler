/* SQLCompilerTokenManager.java */
/* Generated By:JavaCC: Do not edit this line. SQLCompilerTokenManager.java */
import java.io.*;

/** Token Manager. */
@SuppressWarnings ("unused")
public class SQLCompilerTokenManager implements SQLCompilerConstants {
...
null, null, null, null, "\73", "\50", "\51", "\54", "\56", "\75", "\52", null, null, 
null, };
...
static final int[] jjnextStates = {
   111, 113, 85, 88, 92, 119, 121, 98, 101, 105, 76, 77, 
};
...
private void jjCheckNAddTwoStates(int state1, int state2)
{
   ...
   jjCheckNAdd(state2);
    ...
    /** Constructor. */
    public SQLCompilerTokenManager(SimpleCharStream stream){
  ...
  /** Constructor. */
  public SQLCompilerTokenManager (SimpleCharStream stream, int lexState){
    ReInit(stream);
    SwitchTo(lexState);
  }
